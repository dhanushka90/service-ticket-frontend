...
const CreateUpdateTicketComponent = () => {
  const { id } = useParams();
    ...
    <div>
      <div className="container margin-tb-2">
        <div className="row">
          ...
          <h3 className="text-center margin-tb-1">{isUpdate ? 'Update Service Ticket' : 'Add Service Ticket'}</h3>
            <div className="card-body">
              <form>
                ...
                <button className="btn btn-success margin-tb" onClick={saveOrUpdateTicket}>
                  Save
                </button>
...
export default CreateUpdateTicketComponent;
